...
/********************************************************************************
 * Implementation of the OpenABEContextKPDPVS class
 ********************************************************************************/
namespace oabe {

/*!
 * Constructor for the OpenABEContextKPDPVS class.
 *
 */

OpenABEContextKPDPVS::OpenABEContextKPDPVS(unique_ptr<OpenABERNG> rng) : OpenABEContextABE() {
  this->debug = false;
  this->m_RNG_ = move(rng);
  this->algID = OpenABE_SCHEME_KP_DPVS;
}

/*!
 * Destructor for the OpenABEContextKPDPVS class.
 *
 */

OpenABEContextKPDPVS::~OpenABEContextKPDPVS() {}
...
OpenABE_ERROR
OpenABEContextKPDPVS::generateParams(const string pairingParams,
...
OpenABE_ERROR
OpenABEContextKPDPVS::generateDecryptionKey(
...
OpenABE_ERROR
OpenABEContextKPDPVS::encryptKEM(OpenABERNG *rng, const string &mpkID,
...
OpenABE_ERROR
OpenABEContextKPDPVS::decryptKEM(const string &mpkID, const string &keyID,
